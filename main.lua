...
StarterGui:SetCore("SendNotification", {
    Title = "Key System",
    Text = "Link copied! Paste it into your browser to get your key.",
    Duration = 12
})
...
Info.Text = "Paste the link (already copied) into your browser, complete the steps, and get your key from the Pastebin."
...
print("Key accepted. Script unlocked.")
...
local Window = Rayfield:CreateWindow({
	Name = "Rivals by max",
	LoadingTitle = "Rivals by max",
	LoadingSubtitle = "Rivals by max",
	ConfigurationSaving = {
		Enabled = true,
		FolderName = nil,
		FileName = "Rivals by max"
	},
})
...
TeleportTab:CreateButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage"):WaitForChild("Remotes", 9e9):WaitForChild("Misc", 9e9):WaitForChild("ShootingRangeEnter", 9e9):FireServer()
    end,
})
TeleportTab:CreateButton({
...
TeleportTab:CreateButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage"):WaitForChild("Remotes", 9e9):WaitForChild("Matchmaking", 9e9):WaitForChild("JoinQueue", 9e9):InvokeServer("2v2_beginner")
    end,
})
...
ImportantTab:CreateButton({
    Name = "RAGE QUIT",
    Callback = function()
        LocalPlayer:Kick("u rage quit lol cry")
    end,
})
